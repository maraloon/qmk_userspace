...
const key_override_t c_n_o  = ko_make_basic(MOD_MASK_CTRL, KC_N, LOCK_NUM);
...
const key_override_t *key_overrides[] = {&c_h_o, &c_w_o, &c_m_o, &c_c_o, &c_t_o, &c_ar_o, &c_t_o, &c_n_o, &cm_h_o, &cm_c_o, &cm_w_o, &cm_m_o, &cm_t_o, &cm_t_o, NULL};
